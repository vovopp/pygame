...
pygame.display.set_caption("PYGAME自主學習by林宏達")
...
def draw_init():
    draw_text(screen,"太空生存戰",64,WIDTH/2,HEIGHE/4)
    draw_text(screen,"← →移動飛船 空白鍵發射子彈~",22,WIDTH/2,HEIGHE/2)
    draw_text(screen,"按任意鍵開始遊戲!",18,WIDTH/2,HEIGHE*3/4)
...
class ROCK(pygame.sprite.Sprite):
    def __init__(self):
      ...
      #a pygame.draw.circle(self.image, RED,self.rect.center,self.radius)
